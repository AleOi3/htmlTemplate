...
const TemplateOnePage = () => {
    ...
    let asideWidth = 200;
    let bodyMargin = 3;
    let mainHeight = `calc(100vh - ${footerMargin * 2}px - ${headerMargin * 2}px - ${mainMargin * 2}px - ${bodyMargin * 2}px)`;
    let firstWrapWidth = `${mainWidth * 2} - ${asideWidth * 2} - ${navWidth * 2} - ${bodyMargin * 2}`;
    let firstWrapHeight = `calc(100vh - ${footerMargin * 2}px - ${headerMargin * 2}px - ${mainMargin * 2}px - ${bodyMargin * 2}px`;
